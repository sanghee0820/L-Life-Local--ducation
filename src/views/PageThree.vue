            ...
            <div class="content_wrap">
              <div :class="{ 'page': true, 'active': currentPage === 0 }">
                <div class="question">
                  ...
                  <input type="text" id="name" placeholder="Ex) 홍길동" v-model="name" />
                </div>
                <div class="question">
                ...
                <div class="question">
                  ...
                  <input type="text" id="name" placeholder="Ex) 2000-01-01" v-model="brithday"/>
                </div>
              ...
              <div :class="{ 'page': true, 'active': currentPage === 1 }">
                <div class="question">
                  ...
                  <input type="text" id="phone" placeholder="Ex) 010-1234-5678" v-model ="phone">
                </div>
              ...
              <div :class="{ 'page': true, 'active': currentPage === 2 }">
                <div class="question">
                  ...
                  <input type="text" id="address" placeholder="Ex) 대구광역시 북구 대학로 80 (경북대학교)" v-model = "address">
                </div>
                <button2 @click="prevPage">이전</button2>
                <button2 @click="nextPage">다음</button2>
              </div>
...
export default {
  ...
  methods: {
    ...
    submitSurvey() {
      ...
      const serverAddress = 'http://52.79.243.233:8080/mail';
      ...
      if (this.submitted) {
        ...
        console.log("s",this.sex);
        console.log("b",this.brithday);
        ...
        axios.post(serverAddress,{
          ...
          "address_detail" : "dafa",
          "coursename" : this.$store.state.course_name
        })
